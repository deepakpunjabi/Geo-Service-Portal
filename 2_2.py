...
class CinnamonListSettings:
    def __init__(self):
        ...
        self.install_applet = GTKButton('Install Applet', 'Install the Applet', self.copy_applet,
                                        "Install the applet and schema")
        self.uninstall_applet = GTKButton('Uninstall Applet', 'Uninstall the Applet', self.remove_applet,
                                          "Remove the applet and schema")
